...
LearningRate::LearningRate(const LearningRateType _learningRateType, const double _initLearningRate, const double _drop, const int _epocDrop) :
...
double LearningRate::getLearningRate(const int epoc) {
    return learningTypeToFunc[learningRateType](epoc);
}
